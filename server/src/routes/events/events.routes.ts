...
// ── Specific sub-routes MUST come before /:event_id catch-alls ───────────────
// DELETE /:event_id catches everything — /permanent and /staff/:user_id
// must be declared first or Express will never reach them.
...
// ── Generic /:event_id catch-alls — MUST be last ──────────────────────────────
